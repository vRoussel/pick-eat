...
<template>
        ...
        <div class="modal-box relative overflow-visible cursor-default">
            <form autocomplete="off" @submit.prevent="sendIngredient">
                <div class="form-control w-full">
                    ...
                    <input id="name" ref="ingr_name_input_el" v-model="fields.name" class="input input-bordered w-full"
                ...
                <div class="form-control w-full">
                    <label for="" class="label">
                        ...
                        <button class="btn rounded-full btn-primary btn-outline btn-sm modal-button" type="button"
                            tabindex="-1" @mousedown="save_unit_search" @click="open_unit_modal">
                            Unité manquante ?
                        </button>
                    </label>
                    <multiselect ref="multiselect_el" v-model="fields.default_unit" :options="foodStore.units"
                        :strict="false" label="full_name" searchable track-by="full_name" value-prop="id"
    ...
    <new-unit-modal ref="unit_modal_inner_el" :input="unit_search" @created="set_unit"
