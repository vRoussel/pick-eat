<template>
    ...
    >
        ...
        <div class="form-control w-full">
            ...
            <toggle-buttons v-model:picked="diets" :choices="foodStore.diets" />
        </div>
        ...
        <div class="form-control w-full">
            ...
            <textarea v-model="notes" class="textarea textarea-bordered h-32" />
        </div>
            ...
            validator
                ...
                .then(() => {
                    ...
                    if (this.insert_mode) {
                        ...
                        this.foodStore
                            .updateRecipe(this.existing_recipe.id, recipe)
                            .then(() => {
                                this.$emit('done')
                            })
                            .catch((err) => {
