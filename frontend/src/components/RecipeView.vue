...
function image(format = null) {
    ...
    if (props.recipe == null || props.recipe.image === '') return icons.camera
    else return props.recipe.image.replace('/upload', replacement)
}
</script>
            ...
            <div class="basis-full sm:basis-2/5 md:basis-1/3 p-2 sm:p-0">
                <a :href="props.recipe.image">
                    <picture>
                        ...
                        <img :src="image()" :alt="props.recipe.name" class="rounded-xl w-[512px] aspect-square" />
                    </picture>
                </a>
            </div>
