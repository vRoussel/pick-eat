    ...
    methods: {
        async send_password_reset_token_request() {
            validator
                ...
                .then(() => {
                    this.errors = {};
                    this.authStore.ask_password_reset_token(this.email).then(() => {
                        this.notifStore.show_info("Si l'adresse mail correspond bien a votre compte, un email vous a été envoyé")
                        this.email = null
